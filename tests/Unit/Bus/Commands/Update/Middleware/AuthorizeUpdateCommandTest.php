...
class AuthorizeUpdateCommandTest extends TestCase
{
    /**
     * @var ResourceType
     */
    ...
    /**
     * @var AuthorizeUpdateCommand
     */
    private AuthorizeUpdateCommand $middleware;
    ...
    protected function setUp(): void
    {
        ...
        $this->middleware = new AuthorizeUpdateCommand(
    ...
    public function testItPassesAuthorizationWithRequest(): void
    {
        $command = UpdateCommand::make(
            ...
            new Update(null, new ResourceObject($this->type, new ResourceId('123'))),
