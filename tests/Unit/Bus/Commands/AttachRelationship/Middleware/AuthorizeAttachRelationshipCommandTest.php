...
class AuthorizeAttachRelationshipCommandTest extends TestCase
{
    /**
     * @var ResourceType
     */
    ...
    /**
     * @var AuthorizeAttachRelationshipCommand
     */
    private AuthorizeAttachRelationshipCommand $middleware;
    ...
    protected function setUp(): void
    {
        ...
        $this->middleware = new AuthorizeAttachRelationshipCommand(
