...
use LaravelJsonApi\Contracts\Http\Actions\AttachRelationship as AttachRelationshipActionContract;
...
class AttachToManyTest extends TestCase
{
    /**
    ...
    /**
     * @var AttachRelationshipActionContract
     */
    private AttachRelationshipActionContract $action;
    ...
    protected function setUp(): void
    {
        ...
        $this->container->bind(AttachRelationshipActionContract::class, AttachRelationship::class);
        ...
        $this->action = $this->container->make(AttachRelationshipActionContract::class);
    }

    /**
     * @return void
     */
    public function testItAttachesById(): void
    {
     ...
     * @return void
     */
    public function testItAttachesByModel(): void
    {
        $this->route
            ->expects($this->never())
        ...
        ), $validatedQueryParams = ['filter' => ['archived' => 'true']]);
    ...
    private function willParseOperation(string $type, string $id): ListOfResourceIdentifiers
    {
        ...
        $this->container->instance(
            ListOfResourceIdentifiersParser::class,
            $parser = $this->createMock(ListOfResourceIdentifiersParser::class),
        );
