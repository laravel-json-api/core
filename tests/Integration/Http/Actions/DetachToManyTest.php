...
use LaravelJsonApi\Contracts\Http\Actions\DetachRelationship as DetachRelationshipActionContract;
...
class DetachToManyTest extends TestCase
{
    /**
    ...
    /**
     * @var DetachRelationshipActionContract
     */
    private DetachRelationshipActionContract $action;
    ...
    protected function setUp(): void
    {
        ...
        $this->container->bind(DetachRelationshipActionContract::class, DetachRelationship::class);
        ...
        $this->action = $this->container->make(DetachRelationshipActionContract::class);
    }

    /**
     * @return void
     */
    public function testItDetachesById(): void
    {
     ...
     * @return void
     */
    public function testItDetachesByModel(): void
    {
        $this->route
            ->expects($this->never())
